...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d99df9be75d1b7b">
         ...
         <div class="container">
             <form:form action="/SBFormApp/citizen/citizenRegister" method="post" id="userRegForm" modelAttribute="citizen">
               ...
               <table align="center" width="600px">
                ...
                <p style = "text-align: center">click here to login <a href = "/SBFormApp/citizen/login"> login</a> </p>        
